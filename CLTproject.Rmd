...
```
    ...
    I believe with the numb being 25 and the sd being 8.479, I expect our new sd to be around 2.826. You can expect the new sd to be one third of the original.
...
```
  ...
  I believe with the numb being 25 and the original sd being 8.307, I expect the new sd to be 2.769. You can expect the new sd to be one third of the original.
...
# Now finish by adding blocks with numb being 9, then 16, 25, and 36. be sure to mention how the standard deviation progresses as the sample size changes,
  ...
  Unlike before the graph was more varied, this graph with our new standard deviation of about 8 with the numb 25 started off smoother, and the standard deviation seems to be lowering as we continue.. The mean is about 49.57, similar to the other numbers.
