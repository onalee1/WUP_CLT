...
```
    ...
    I believe with the numb being 16 and the sd being 10.00, I expect our new sd to be around 3.33. You can expect the new sd to be one third of the original.
...
```
  ...
  I believe with the numb being 16 and the original sd being 10.60, I expect the new sd to be 3.533. You can expect the new sd to be one third of the original.
...
# Now finish by adding blocks with numb being 9, then 16, 25, and 36. be sure to mention how the standard deviation progresses as the sample size changes,
  ...
  Unlike before the graph was more varied, this graph with our new standard deviation of about 10 with the numb 16 is smoother and has fewer peaks and dips. The mean is about 49.74.
